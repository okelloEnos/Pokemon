...
//
// [ClassicHeader]
class MoreFooter extends LoadIndicator {
...
class _ClassicFooterState extends LoadIndicatorState<MoreFooter> {
  ...
  // todo: implement customized widgets
  Widget _buildCustomized(LoadStatus? mode) {
    return Row(
      children: [
